...
CREATE TABLE IF NOT EXISTS `Sysurvey`.`module_access` (
  ...
  INDEX `fk_module_access_permisions1_idx` (`permisions_idpermision` ASC),
  CONSTRAINT `fk_module_access_user_types1`
    FOREIGN KEY (`user_types_iduser_type`)
    REFERENCES `Sysurvey`.`user_types` (`iduser_type`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_module_access_modules1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_module_access_permisions1`
