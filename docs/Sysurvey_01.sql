...
/*
 INSERT INTO surveys (`name`,`active`) VALUE ('Survey 1', TRUE);
 INSERT INTO surveys (`name`,`active`) VALUE ('Survey 2', TRUE);
 INSERT INTO surveys (`name`,`active`) VALUE ('Survey 3', TRUE);
...
*/
 ...
 -- INSERT INTO users(email,`name`,`password`,`active`,`last_login`,`register_date`) VALUES('elix.cd@gmai.com','elix', '12345', TRUE, NOW(),NOW());
