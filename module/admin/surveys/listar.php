                ...
                <?php foreach ($Surveys as $row) : ?>
                    <tr>
                        <?php foreach ($row as $key => $value) : ?>
                            ...
                            <?php endif ?>
                        <?php endforeach ?>
                        <td><a class="alert-link" onclick="Breadcrumb('Encuestas','Editar');ViewLoad('Editar','POST','action=Editar&idSurvey=<?php echo $row['idsurvey']; ?>');setIdSurvey(<?php echo $row['idsurvey']; ?>);">Editar</a> | Borrar </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
        </table>
